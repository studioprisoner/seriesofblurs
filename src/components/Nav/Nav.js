...
export default function Nav() {
    return (
        <div>
            ...
            {({ open }) => (
                <>
                <div className="max-w-7xl pb-8 mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                    <div className="flex items-center">
                        <div className="hidden sm:block sm:ml-6">
                        <div className="flex space-x-4">
                            {/* Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" */}
                            <a href="/" className="text-white hover:text-scarlet-500 px-3 py-2 text-lg font-poppins font-medium uppercase">
                            Home
                            </a>
                            <a
                            href="/movies"
                            className="text-white hover:text-scarlet-500 px-3 py-2 text-lg font-poppins font-medium uppercase"
                            >
                            Movies
                            </a>
                            <a
                            href="/work"
                            className="text-white hover:text-scarlet-500 px-3 py-2 text-lg font-poppins uppercase"
                            >
                            Work With Me
                            </a>
                        </div>
                ...
                <Disclosure.Panel className="sm:hidden relative">
                        <div className="pt-2 pb-3 space-y-1">
                            <a
                                href="/"
                                className="text-white block pl-3 pr-4 py-2 text-lg hover:text-scarlet-500 font-poppins font-medium uppercase"
                            >
                                Home
                            </a>
                            <a
