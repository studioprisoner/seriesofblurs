        ...
        <div>
            <section>
                <div className="max-w-7xl mx-auto sm:py-20 px-8">
                        ...
                        <div className="bg-scarlet-500 rounded-lg p-5">
                            <h3 className="text-blue-charcoal-500 font-poppins font-semibold uppercase  text-3xl">Foreign</h3>
                            <ul className="m-auto text-white text-xs font-spacemono list-none">
                        ...
                        <div className="bg-scarlet-500 rounded-lg p-5">
                            <h3 className="text-blue-charcoal-500 font-poppins font-semibold uppercase  text-3xl">Classics</h3>
                            <ul className="m-auto text-white text-xs font-spacemono list-none">
                        ...
                        <div className="bg-scarlet-500 rounded-lg p-5">
                            <h3 className="text-blue-charcoal-500 font-poppins font-semibold uppercase  text-3xl">The 90's</h3>
                            <ul className="m-auto text-white text-xs font-spacemono list-none">
                        ...
                        <div className="bg-scarlet-500 rounded-lg p-5 sm:w-1/6 mt-6">
                            <h3 className="text-blue-charcoal-500 font-poppins font-semibold uppercase  text-3xl">2000's</h3>
                            <ul className="m-auto text-white text-xs font-spacemono list-none">
