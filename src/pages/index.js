  ...
  return (
    ...
    <div className="">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:py-16 sm:px-6 lg:px-8">
                ...
                <p className="mt-6 max-w-3xl text-3xl text-white font-poppins">Video Games &amp; Horror Movies</p>
                ...
                <div class="py-6">
                  <a
                    href="/work" 
                    className="w-full sm:w-1/2 flex justify-center py-2 px-4 border border-transparent rounded-2xl text-white bg-scarlet-500 hover:bg-scarlet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-scarlet-500 font-poppins">
                    Work With Me
                </a>
                </div>
            </div>
            <section className="max-w-7xl mx-auto relative px-4 sm:px-6 lg:px-8" aria-labelledby="reach-heading">
            <h2 className="text-3xl tracking-tight sm:text-4xl lg:text-5xl text-white font-poppins">Reach</h2>
